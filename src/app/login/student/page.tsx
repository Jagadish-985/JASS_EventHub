      ...
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-center text-gray-900 dark:text-white">Student Login</CardTitle>
            <CardDescription className="text-center text-gray-600 dark:text-gray-400">Enter your email below to login to your account</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <div className="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
              ...
              <Link href="/signup/student" className="underline text-primary">
                Sign up
              </Link>
            </div>
          </CardContent>
