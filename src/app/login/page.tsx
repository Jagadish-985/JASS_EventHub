    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900 p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl text-center text-gray-900 dark:text-white">Login As</CardTitle>
            <CardDescription className="text-center text-gray-600 dark:text-gray-400">Please select your role to continue.</CardDescription>
          </CardHeader>
