       ...
       <div className="w-full max-w-md">
        ...
        <Card className="bg-white dark:bg-gray-800 shadow-lg">
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-center text-gray-900 dark:text-white">Student Sign Up</CardTitle>
            <CardDescription className="text-center text-gray-600 dark:text-gray-400">Enter your information to create an account</CardDescription>
          </CardHeader>
          <CardContent>
